...
const LegalPageShell: React.FC<LegalPageShellProps> = ({ title, description, breadcrumbs, children }) => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  return (
    <main className="min-h-screen bg-[#0B0B0B] text-[#F5F5F5]">
      ...
      <div className="mx-auto max-w-5xl px-6 py-20">
        <nav aria-label="Breadcrumb" className="mb-10 text-sm text-white/60">
